...
const iic_master_extended_cfg_t g_i2c_master2_extend =
{
    ...
    .smbus_operation         = 0,
    /* Actual calculated bitrate: 99404. Actual calculated duty cycle: 49%. */ .clock_settings.brl_value = 28, .clock_settings.brh_value = 27, .clock_settings.cks_value = 3, .clock_settings.sddl_value = 0, .clock_settings.dlcs_value = 0,
};
...
sci_uart_instance_ctrl_t     g_uart7_ctrl;
            ...
            const uart_cfg_t g_uart7_cfg =
            {
                ...
                .parity              = UART_PARITY_OFF,
                .stop_bits           = UART_STOP_BITS_1,
                .p_callback          = debug_uart7_callback,
                .p_context           = NULL,
